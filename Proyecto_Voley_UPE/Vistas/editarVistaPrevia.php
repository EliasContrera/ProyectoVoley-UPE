...
<body>
    ...
    <form action="../Controlador/vistaPreviaEdit.php" class="text-black" method="POST" style="padding-top: 5%">

        <div class="mb-3 ">
                    <label for="idNoticiaVistaPrevia">Seleccione la vista previa de la noticia Editar:</label>
                    <select id="idNoticiaVistaPrevia" name="idNoticiaVistaPrevia" class="form-control">
                    <option value=""></option>
                    <?php
                    //La variable almacena los datos que retorne despues de ejecturar la consulta
                    $opcionesNoticias = obtenerOpciones("noticiasprincipales");//Acá obtengo las opciones de la tabla especialidades para el campo select 
        ...
        <div class="mb-3 ">
            <label for="TituloVistaPrevia" >Nuevo Título:</label>
            <input type="text" class="form-control" id="TituloVistaPrevia" name="TituloVistaPrevia" value="">
        </div>
        <div class="mb-3 ">
            <label for="textoVistaPrevia" >Nueva Descripcion de la Noticia:</label>
