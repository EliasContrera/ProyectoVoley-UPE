...
<body>
    ...
    <div class="container-fluid p-5 bg-primary text-white text-center" style="padding-top: 10%;">
        ...
        <p>Actualizar la Vista Previa de la Noticia correspondiente seleccionando el ID.</p> 
    </div>
    <!-- Formulario de edición de la noticia -->
    <form action="../Controlador/vistaPreviaEdit.php" method="POST" style="padding-top: 5%">
        <div class="form-group" >
            <label for="idNoticiaVistaPrevia" class="text-black">Ingrese el ID de la noticia a editar:</label>
            <input type="number" class="form-control" id="idNoticiaVistaPrevia" name="idNoticiaVistaPrevia" value="">
        </div>
        <div class="form-group">
            <label for="TituloVistaPrevia" class="text-black">Nuevo Título:</label>
            <input type="text" class="form-control" id="TituloVistaPrevia" name="TituloVistaPrevia" value="">
        </div>
        <div class="form-group">
            <label for="textoVistaPrevia" class="text-black">Nueva Descripcion de la Noticia:</label>
